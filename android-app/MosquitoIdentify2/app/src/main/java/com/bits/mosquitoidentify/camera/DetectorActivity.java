package com.bits.mosquitoidentify.camera;
...
import com.bits.mosquitoidentify.R;
import com.bits.mosquitoidentify.camera.env.BorderedText;
import com.bits.mosquitoidentify.camera.env.ImageUtils;
import com.bits.mosquitoidentify.camera.tracker.MultiBoxTracker;
import com.bits.mosquitoidentify.customview.OverlayView;
import com.bits.mosquitoidentify.TfliteRunner;
...
public class DetectorActivity extends CameraActivity implements ImageReader.OnImageAvailableListener {
    ...
    public void onPreviewSizeChosen(final Size size, final int rotation) {
        ...
        try {
            detector = new TfliteRunner(this, MODE, TF_OD_API_INPUT_SIZE, 0.40f, 0.55f);
